...
export function BuyerNode({ data, selected }: RFNodeProps<"buyer">) {
  ...
  return (
    <NodeFrame icon={meta.icon} title={t("trafficUI.routing.nodes.buyer.label")} tone={meta.tone} selected={selected} outputs={[]}>
      <div className="space-y-1">
        <div className="truncate text-sm font-semibold">{cfg.buyerName || t("trafficUI.routing.nodes.buyer.pickBuyer")}</div>
