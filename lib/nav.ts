...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "IVR",           nameKey: "nav.ivr",          href: ROUTES.ivr,       icon: PhoneForwarded,  roles: ["admin"] },
      { label: "Call Queue",    nameKey: "nav.callQueue",    href: ROUTES.queue,     icon: PhoneIncoming,   roles: ["admin"] },
    ],
  },
  {
    label: "Network",
