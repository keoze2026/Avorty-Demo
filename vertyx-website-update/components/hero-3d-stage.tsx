...
import { Play, Shield, CheckCircle, Star } from "lucide-react"
          ...
          <div className="w-full flex justify-center px-6 mt-16">
            <div className="w-full max-w-4xl">
              ...
              >
                Turn every ring
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">into revenue.</span>
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                The most intelligent call-tracking platform — real-time routing, 
                live monitoring, and AI-driven optimization for the modern pay-per-call network.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <button className="text-zinc-300 font-medium hover:text-white transition-colors flex items-center gap-2 text-sm border border-zinc-700 px-4 py-2.5 rounded-lg hover:bg-zinc-800/50">
              ...
              <motion.div
                ...
                className="mt-10 flex items-center gap-4 text-xs text-zinc-500"
              >
